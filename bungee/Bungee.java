package com.goldfinch.bunker.bungee;
...
public class Bungee implements PluginMessageListener {
    ...
    public static void sendPlayer(Player player, String server) {
        ...
        player.sendPluginMessage(Bunker.getInstance(), "BungeeCord", out.toByteArray());
    }
    ...
    public static void getPlayerCount(String server) {
        ...
        Bukkit.getServer().sendPluginMessage(Bunker.getInstance(), "BungeeCord", out.toByteArray());
    }
